...
import { getTemplateEngine } from '../../../lib/engine';
...
import * as AgentPresentations from '@contractspec/example.agent-console/presentations';
import * as SaasPresentations from '@contractspec/example.saas-boilerplate/presentations';
import * as CrmPresentations from '@contractspec/example.crm-pipeline/presentations';
import * as LearningJourneyPresentations from '@contractspec/example.learning-journey-registry/presentations';
