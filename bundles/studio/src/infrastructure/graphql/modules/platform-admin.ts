...
import type { SecretPayloadEncoding } from '@contractspec/lib.contracts/integrations/secrets/provider';
...
export function registerPlatformAdminSchema(
  ...
  const PlatformIntegrationSpecType = builder
    ...
    .implement({
      fields: (t) => ({
        ...
        version: t.int({ resolve: (s) => parseInt(s.meta.version, 10) }),
