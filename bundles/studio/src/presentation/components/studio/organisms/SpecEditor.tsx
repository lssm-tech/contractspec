...
const SPEC_TEMPLATES: Record<SpecType, string> = {
  CAPABILITY: `import { defineCapability, StabilityEnum, schemaModel } from '@contractspec/lib.contracts';
...
`,
  WORKFLOW: `import { defineWorkflow, StabilityEnum } from '@contractspec/lib.contracts';
...
`,
  POLICY: `import { definePolicy } from '@contractspec/lib.contracts';
...
`,
  DATAVIEW: `import { defineDataView } from '@contractspec/lib.contracts';
...
`,
  COMPONENT: `import { defineComponentSpec } from '@contractspec/lib.contracts';
