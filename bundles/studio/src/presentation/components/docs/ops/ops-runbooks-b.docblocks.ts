...
## 1. Prerequisites
- Register a \`DeploymentStrategy\` via \`@contractspec/lib.progressive-delivery\`.
- Ensure adapters emit telemetry through \`@contractspec/lib.observability\` (HTTP middleware + custom metrics).
