          ...
          <div className="border-t p-4">
            <div className="flex gap-2">
              <textarea
                ...
                className="bg-input placeholder:text-muted-foreground flex-1 resize-none rounded-md border px-3 py-2 text-sm focus:ring-2 focus:ring-offset-2 focus:outline-none"
                rows={2}
                disabled={isLoading}
              />
              <Button
