...
/**
 * Check if code imports from @contractspec/lib.schema.
 */
function checkSchemaImport(
  ...
  const hasImport =
    code.includes("from '@contractspec/lib.schema'") ||
    code.includes('from "@contractspec/lib.schema"');
  ...
  return {
    ...
    details: hasImport
      ? undefined
      : 'Missing import from @contractspec/lib.schema',
    suggestion: "Add: import { ... } from '@contractspec/lib.schema';",
  };
}
