...
This pack contains workspace and product context that is specific to the ContractSpec repository.
...
- Cross-project engineering quality policies (put those in `software-best-practices`).
- ContractSpec governance and specification-process rules (put those in `contractspec-rules`).
- Tooling/server integrations unrelated to workspace context.
