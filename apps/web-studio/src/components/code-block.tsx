...
export async function CodeBlock({
  ...
  return (
    <div className={cn("relative overflow-hidden rounded-lg border bg-zinc-950 dark:border-zinc-800", className)} {...props}>
      {filename && (
      ...
      <div className="relative">
        ...
        <div
          className={cn(
            "p-4 overflow-x-auto text-[13px] leading-6 font-mono",
