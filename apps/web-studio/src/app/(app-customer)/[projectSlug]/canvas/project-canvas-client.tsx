...
import { StudioCanvas } from '@contractspec/bundle.studio/presentation/components/studio/organisms/StudioCanvas';
import type { ComponentNode } from '@contractspec/bundle.studio/modules/visual-builder';
import {
  useCanvasVersions,
...
export default function ProjectCanvasClient() {
  ...
  return (
    <div className="space-y-4">
      ...
      <StudioCanvas state={canvas} onNodesChange={(next) => setNodes(next)} />
            ...
            versions.map((v) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    variant={v.status === 'deployed' ? 'default' : 'secondary'}
                  >
                    {v.status}
                  </Badge>
                  <Button
