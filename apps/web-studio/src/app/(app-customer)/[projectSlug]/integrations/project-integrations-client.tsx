...
import { IntegrationMarketplace } from '@contractspec/bundle.library';
import {
  STUDIO_INTEGRATIONS_QUERY,
...
import { IntegrationProviderEnum } from '@contractspec/lib.gql-client-studio';

export default function ProjectIntegrationsClient() {
  const project = useSelectedProject();
  const { data, isLoading, refetch } = useGraphQL(STUDIO_INTEGRATIONS_QUERY, {
    ...
    <div className="space-y-4">
          ...
          <Button
            ...
            onPress={async () => {
              ...
              await connect.mutateAsync({
                provider: IntegrationProviderEnum.Github,
                projectId: project.id,
                name: `GitHub: ${path}`,
                ownershipMode: 'byok',
                secretProvider: 'env',
      ...
      <IntegrationMarketplace
        integrations={integrations.map((i) => ({
          id: i.id ?? '',
          provider: i.provider as IntegrationProviderEnum,
          name: i.name ?? 'Unknown',
          category: 'repo',
