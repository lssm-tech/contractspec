...
import { AuthProvider } from '@contractspec/bundle.studio/presentation/providers/auth';
...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://contractspec.studio'),
  keywords: [
