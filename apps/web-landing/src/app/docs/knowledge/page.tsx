...
export default function KnowledgeOverviewPage() {
  ...
  intendedAudience: "agents" | "humans" | "admin-only";
          ...
          <div className="card-subtle p-4">
            ...
            <CodeBlock
              language="typescript"
              code={`type KnowledgeSourceConfig = {
  id: string;
  tenantId: string;
  spaceId: string;
  ...
  lastSyncedAt?: string;
      ...
      <div className="space-y-4">
        ...
        <CodeBlock
          language="typescript"
          filename="workflows/answer-support-question.ts"
          code={`import { defineWorkflow } from '@contractspec/lib.contracts';
