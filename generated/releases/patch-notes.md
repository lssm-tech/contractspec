...
- Date: 2026-04-19
- Breaking: no
- @contractspec/lib.contracts-spec@5.6.0 (minor)
- @contractspec/module.workspace@4.3.3 (minor)
- @contractspec/bundle.workspace@4.5.3 (minor)
- @contractspec/bundle.library@3.9.5 (minor)
- @contractspec/app.cli-contractspec@6.1.2 (minor)
- vscode-contractspec@3.10.6 (minor)
- contractspec@1.46.2 (patch)
- @contractspec/lib.knowledge@3.7.23 (patch)
- @contractspec/biome-config@3.8.10 (patch)
...
- @contractspec/bundle.library@3.9.5 (patch)
- @contractspec/lib.contracts-spec@5.6.0 (patch)
- @contractspec/tool.bun@3.7.18 (patch)
- @contractspec/tool.docs-generator@3.7.22 (patch)
- @contractspec/biome-config@3.8.10 (patch)
...
- Date: 2026-04-15
- Breaking: no
- @contractspec/bundle.workspace@4.5.3 (patch)
- @contractspec/app.cli-contractspec@6.1.2 (patch)
...
- Date: 2026-04-10
- Breaking: no
- @contractspec/lib.builder-spec@0.2.5 (minor)
- @contractspec/lib.builder-runtime@0.2.5 (minor)
- @contractspec/lib.mobile-control@0.2.5 (minor)
- @contractspec/lib.provider-runtime@0.2.5 (minor)
- @contractspec/module.builder-workbench@0.2.7 (minor)
- @contractspec/module.mobile-review@0.2.7 (minor)
- @contractspec/integration.runtime.local@0.2.5 (minor)
- @contractspec/integration.provider.gemini@0.2.4 (minor)
- @contractspec/app.cli-contractspec@6.1.2 (minor)
- @contractspec/bundle.library@3.9.5 (patch)
...
- @contractspec/lib.contracts-spec@5.6.0 (patch)
- @contractspec/lib.builder-spec@0.2.5 (minor)
- @contractspec/lib.provider-spec@0.2.3 (minor)
- @contractspec/lib.builder-runtime@0.2.5 (minor)
- @contractspec/lib.mobile-control@0.2.5 (minor)
- @contractspec/lib.provider-runtime@0.2.5 (minor)
- @contractspec/module.builder-workbench@0.2.7 (minor)
- @contractspec/module.mobile-review@0.2.7 (minor)
- @contractspec/integration.runtime@3.9.5 (minor)
- @contractspec/integration.runtime.managed@0.2.5 (minor)
- @contractspec/integration.runtime.local@0.2.5 (minor)
- @contractspec/integration.runtime.hybrid@0.2.5 (minor)
- @contractspec/integration.builder-telegram@0.2.5 (minor)
- @contractspec/integration.builder-voice@0.2.5 (minor)
- @contractspec/integration.builder-whatsapp@0.2.5 (minor)
- @contractspec/integration.provider.codex@0.2.4 (minor)
- @contractspec/integration.provider.claude-code@0.2.4 (minor)
- @contractspec/integration.provider.gemini@0.2.4 (minor)
- @contractspec/integration.provider.copilot@0.2.4 (minor)
- @contractspec/integration.provider.stt@0.2.4 (minor)
- @contractspec/integration.provider.local-model@0.2.4 (minor)
...
- Breaking: yes
- @contractspec/bundle.workspace@4.5.3 (minor)
- @contractspec/app.cli-contractspec@6.1.2 (major)
- @contractspec/action.version@3.0.3 (major)
...
- Breaking: no
- contractspec@1.46.2 (patch)
- @contractspec/lib.contracts-runtime-client-react@3.11.0 (patch)
- @contractspec/lib.design-system@4.0.0 (patch)
- @contractspec/lib.ui-kit-web@3.12.0 (patch)
...
- @contractspec/biome-config@3.8.10 (patch)
- contractspec@1.46.2 (patch)
- @contractspec/lib.ui-kit@4.1.0 (patch)
- @contractspec/lib.ui-kit-web@3.12.0 (patch)
- @contractspec/lib.ui-kit-core@3.8.3 (patch)
- @contractspec/lib.design-system@4.0.0 (patch)
- Maintainer: Maintainers get generated repo and consumer Biome presets that reject raw layout tags and raw JSX text outside typography components, with monorepo apps excluded by default and a conservative fixer command for deterministic replacements.
...
- Date: 2026-04-19
- Breaking: no
- @contractspec/lib.data-exchange-core@0.2.3 (minor)
- @contractspec/lib.data-exchange-server@0.2.3 (minor)
- @contractspec/lib.data-exchange-client@0.2.4 (minor)
...
- Date: 2026-04-19
- Breaking: no
- @contractspec/lib.design-system@4.0.0 (minor)
- @contractspec/lib.presentation-runtime-react@38.0.3 (patch)
- @contractspec/lib.ui-kit-web@3.12.0 (patch)
- @contractspec/lib.ui-kit@4.1.0 (patch)
- @contractspec/example.crm-pipeline@3.7.25 (patch)
- @contractspec/example.data-grid-showcase@3.8.17 (patch)
...
- Date: 2026-04-21
- Breaking: yes
- @contractspec/lib.ui-kit@4.1.0 (major)
- @contractspec/integration.providers-impls@4.0.2 (major)
- @contractspec/lib.runtime-sandbox@3.0.2 (major)
- @contractspec/lib.example-shared-ui@7.0.2 (major)
- @contractspec/lib.video-gen@3.0.2 (major)
- @contractspec/lib.ui-kit-web@3.12.0 (minor)
- @contractspec/app.cli-contractspec@6.1.2 (minor)
- @contractspec/app.api-library (patch)
- @contractspec/app.registry-packs@1.7.17 (patch)
- vscode-contractspec@3.10.6 (patch)
- @contractspec/example.project-management-sync@3.7.24 (patch)
- @contractspec/example.voice-providers@3.7.24 (patch)
- @contractspec/example.meeting-recorder-providers@3.7.24 (patch)
- @contractspec/example.integration-posthog@3.7.24 (patch)
- contractspec@1.46.2 (patch)
...
- Breaking: no
- @contractspec/lib.contracts-spec@5.6.0 (minor)
- @contractspec/lib.contracts-runtime-client-react@3.11.0 (minor)
- @contractspec/lib.design-system@4.0.0 (minor)
- @contractspec/lib.ui-kit-web@3.12.0 (patch)
- @contractspec/lib.ui-kit@4.1.0 (patch)
...
- @contractspec/lib.design-system@4.0.0 (minor)
- @contractspec/lib.ui-kit-web@3.12.0 (minor)
- @contractspec/lib.ui-kit@4.1.0 (minor)
- @contractspec/lib.ui-kit-core@3.8.3 (patch)
...
- Breaking: no
- @contractspec/tool.bun@3.7.18 (patch)
- @contractspec/bundle.marketing@3.8.18 (patch)
- @contractspec/lib.accessibility@3.7.24 (patch)
- @contractspec/lib.contracts-runtime-client-react@3.11.0 (patch)
- @contractspec/lib.design-system@4.0.0 (patch)
- @contractspec/lib.example-shared-ui@7.0.2 (patch)
- @contractspec/lib.presentation-runtime-react@38.0.3 (patch)
- @contractspec/lib.surface-runtime@0.5.23 (patch)
- @contractspec/lib.ui-kit@4.1.0 (patch)
- @contractspec/lib.ui-kit-web@3.12.0 (patch)
- @contractspec/lib.ui-link@3.7.18 (patch)
- @contractspec/lib.video-gen@3.0.2 (patch)
- @contractspec/module.builder-workbench@0.2.7 (patch)
- @contractspec/module.examples@4.0.2 (patch)
- @contractspec/module.execution-console@0.1.8 (patch)
- @contractspec/module.mobile-review@0.2.7 (patch)
...
- @contractspec/lib.contracts-runtime-client-react@3.11.0 (minor)
- @contractspec/lib.design-system@4.0.0 (minor)
- @contractspec/lib.ui-kit-core@3.8.3 (minor)
- @contractspec/lib.ui-kit-web@3.12.0 (minor)
- @contractspec/lib.ui-kit@4.1.0 (minor)
- vscode-contractspec@3.10.6 (minor)
...
- Date: 2026-04-21
- Breaking: no
- @contractspec/lib.presentation-runtime-core@5.0.3 (patch)
...
- @contractspec/bundle.library@3.9.5 (patch)
- @contractspec/bundle.marketing@3.8.18 (patch)
- @contractspec/example.agent-console@3.8.17 (patch)
- @contractspec/module.examples@4.0.2 (minor)
...
- Date: 2026-04-22
- Breaking: yes
- @contractspec/lib.design-system@4.0.0 (major)
- @contractspec/lib.presentation-runtime-core@5.0.3 (patch)
- @contractspec/bundle.library@3.9.5 (patch)
...
- @contractspec/tool.bun@3.7.18 (patch)
- @contractspec/lib.design-system@4.0.0 (patch)
- @contractspec/module.ai-chat@4.3.25 (patch)
...
- Breaking: no
- @contractspec/lib.presentation-runtime-react@38.0.3 (patch)
- @contractspec/lib.presentation-runtime-react-native@38.0.3 (patch)
...
- Date: 2026-04-19
- Breaking: no
- @contractspec/module.notifications@3.7.22 (patch)
...
- Date: 2026-04-20
- Breaking: yes
- @contractspec/lib.presentation-runtime-core@5.0.3 (major)
...
- Date: 2026-04-19
- Breaking: yes
- @contractspec/module.learning-journey@4.0.3 (major)
- @contractspec/module.examples@4.0.2 (patch)
- @contractspec/example.learning-journey-ambient-coach@4.0.3 (major)
- @contractspec/example.learning-journey-crm-onboarding@4.0.5 (major)
- @contractspec/example.learning-journey-duo-drills@4.0.3 (major)
- @contractspec/example.learning-journey-platform-tour@4.0.3 (major)
- @contractspec/example.learning-journey-quest-challenges@4.0.3 (major)
- @contractspec/example.learning-journey-registry@4.0.5 (major)
- @contractspec/example.learning-journey-studio-onboarding@4.0.3 (major)
- @contractspec/example.learning-journey-ui-coaching@4.0.5 (major)
- @contractspec/example.learning-journey-ui-gamified@4.0.5 (major)
- @contractspec/example.learning-journey-ui-onboarding@4.0.5 (major)
- @contractspec/example.learning-journey-ui-shared@4.0.5 (major)
- @contractspec/example.learning-patterns@4.0.3 (major)
...
- Date: 2026-04-15
- Breaking: no
- @contractspec/integration.builder-telegram@0.2.5 (patch)
- @contractspec/integration.builder-voice@0.2.5 (patch)
- @contractspec/integration.builder-whatsapp@0.2.5 (patch)
- @contractspec/integration.provider.claude-code@0.2.4 (patch)
- @contractspec/integration.provider.codex@0.2.4 (patch)
- @contractspec/integration.provider.copilot@0.2.4 (patch)
- @contractspec/integration.provider.gemini@0.2.4 (patch)
- @contractspec/integration.provider.local-model@0.2.4 (patch)
- @contractspec/integration.provider.stt@0.2.4 (patch)
- @contractspec/integration.runtime.hybrid@0.2.5 (patch)
- @contractspec/integration.runtime.local@0.2.5 (patch)
- @contractspec/integration.runtime.managed@0.2.5 (patch)
...
- Date: 2026-04-15
- Breaking: yes
- @contractspec/lib.support-bot@4.0.3 (major)
...
- Breaking: no
- @contractspec/lib.contracts-spec@5.6.0 (minor)
- @contractspec/lib.contracts-runtime-server-rest@3.8.2 (minor)
- @contractspec/lib.contracts-runtime-server-graphql@3.8.2 (minor)
- @contractspec/lib.contracts-runtime-server-mcp@3.8.3 (minor)
- @contractspec/lib.contracts-runtime-client-react@3.11.0 (minor)
- @contractspec/lib.jobs@3.8.2 (minor)
- @contractspec/lib.error@3.7.16 (patch)
...
- Date: 2026-04-21
- Breaking: yes
- @contractspec/module.examples@4.0.2 (major)
- @contractspec/app.cli-contractspec@6.1.2 (minor)
- @contractspec/bundle.marketing@3.8.18 (patch)
- @contractspec/bundle.library@3.9.5 (patch)
...
- @contractspec/app.expo-demo (patch)
- @contractspec/example.agent-console@3.8.17 (patch)
- @contractspec/example.ai-chat-assistant@3.8.17 (patch)
- @contractspec/example.analytics-dashboard@3.9.17 (patch)
- @contractspec/example.crm-pipeline@3.7.25 (patch)
- @contractspec/example.integration-hub@3.8.17 (patch)
- @contractspec/example.learning-journey-registry@4.0.5 (patch)
- @contractspec/example.marketplace@3.8.17 (patch)
- @contractspec/example.policy-safe-knowledge-assistant@3.7.25 (patch)
- @contractspec/example.saas-boilerplate@3.8.17 (patch)
- @contractspec/example.workflow-system@3.8.17 (patch)
