...
- **File**: `packages/examples/marketplace/src/marketplace.feature.ts`

## Operations (8)

- `marketplace.store.create` (v1.0.0)
- `marketplace.product.create` (v1.0.0)
- `marketplace.product.list` (v1.0.0)
- `marketplace.order.create` (v1.0.0)
- `marketplace.order.updateStatus` (v1.0.0)
- `marketplace.payout.list` (v1.0.0)
- `marketplace.review.create` (v1.0.0)
- `marketplace.review.list` (v1.0.0)

## Events (14)

- `marketplace.store.created` (v1.0.0)
- `marketplace.store.statusChanged` (v1.0.0)
- `marketplace.product.created` (v1.0.0)
- `marketplace.product.published` (v1.0.0)
- `marketplace.inventory.updated` (v1.0.0)
- `marketplace.order.created` (v1.0.0)
- `marketplace.order.paid` (v1.0.0)
- `marketplace.order.statusUpdated` (v1.0.0)
- `marketplace.order.shipped` (v1.0.0)
- `marketplace.order.completed` (v1.0.0)
- `marketplace.payout.created` (v1.0.0)
- `marketplace.payout.paid` (v1.0.0)
- `marketplace.review.created` (v1.0.0)
- `marketplace.review.responded` (v1.0.0)

## Presentations (12)

- `marketplace.store.profile` (v1.0.0)
- `marketplace.seller.dashboard` (v1.0.0)
- `marketplace.product.catalog` (v1.0.0)
- `marketplace.product.detail` (v1.0.0)
- `marketplace.product.editor` (v1.0.0)
