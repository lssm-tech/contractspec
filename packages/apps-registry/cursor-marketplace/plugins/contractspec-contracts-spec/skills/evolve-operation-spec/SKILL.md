...
description: >-
  Evolve operation contracts in @contractspec/lib.contracts-spec with
...
5. Pass risky mutations through the Connect review loop.
6. Add migration notes for every breaking change.
...
- Connect artifacts under `.contractspec/connect/*` explain any review or denial path.
