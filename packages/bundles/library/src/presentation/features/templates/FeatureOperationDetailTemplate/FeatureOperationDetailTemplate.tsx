    ...
    return (
      ...
      >
        ...
        <EmptyState
          ...
          icon={<Zap className="text-muted-foreground h-12 w-12" />}
        />
      </VStack>
    );
  }
          ...
          <Card className="p-6">
            <VStack gap="md">
              ...
              {spec ? (
                ...
                <VStack gap="md">
                  <p className="text-muted-foreground">
                    Full schema details are not available for this operation
                    reference.
                  </p>
                  <CodeBlock
            ...
            <VStack gap="md">
              ...
              <dl className="grid grid-cols-1 gap-4 text-sm">
                <div>
                  ...
                  <dd className="truncate font-medium">{opRef.key}</dd>
                </div>
                <div>
