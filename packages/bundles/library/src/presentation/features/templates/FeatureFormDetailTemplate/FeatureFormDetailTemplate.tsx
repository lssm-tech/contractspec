...
import { BookOpen, Code, Database, PenTool } from 'lucide-react';
    ...
    return (
      ...
      >
        ...
        <EmptyState
          ...
          icon={<PenTool className="text-muted-foreground h-12 w-12" />}
        />
      </VStack>
    );
  }
          ...
          <Card className="p-6">
            <VStack gap="md">
              <HStack className="items-center gap-2 border-b pb-2">
                ...
                <h3 className="text-lg font-semibold">Form Definition</h3>
              </HStack>
              ...
              {spec ? (
                ...
                <VStack gap="md">
                  <p className="text-muted-foreground">
                    Full form definition details are not available for this form
                    reference.
                  </p>
                  <CodeBlock
            ...
            <VStack gap="md">
              ...
              <dl className="grid grid-cols-1 gap-4 text-sm">
                <div>
                  ...
                  <dd className="truncate font-medium">{formRef.key}</dd>
                </div>
                <div>
