...
export function IntegrationsPowensPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Powens Open Banking</h1>
...
pollingIntervalMs?: 300000`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Capabilities</h2>
				<div className="overflow-x-auto rounded-lg border border-border bg-background/50 p-4 font-mono text-muted-foreground text-sm">
...
outputs:
  balances:
    ...
    description: "Current/available balances with timestamps"`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Primary workflows</h2>
				<div className="space-y-3">
					<h3 className="font-semibold text-lg">Account sync</h3>
					<p className="text-muted-foreground">
						The workflow{' '}
				...
				<div className="space-y-3">
					<h3 className="font-semibold text-lg">Transaction sync</h3>
					<p className="text-muted-foreground">
						<code className="rounded bg-background/50 px-2 py-1">
				...
				<div className="space-y-3">
					<h3 className="font-semibold text-lg">Balance refresh</h3>
					<p className="text-muted-foreground">
						<code className="rounded bg-background/50 px-2 py-1">
				...
				<div className="space-y-3">
					<h3 className="font-semibold text-lg">Derived financial overview</h3>
					<p className="text-muted-foreground">
						<code className="rounded bg-background/50 px-2 py-1">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Telemetry & guardrails</h2>
