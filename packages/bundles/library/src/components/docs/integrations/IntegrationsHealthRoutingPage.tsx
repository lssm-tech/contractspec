...
export function IntegrationsHealthRoutingPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Health Routing Strategy</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Connection config fields</h2>
  ...
  "oauthTokenUrl": "https://api.provider.example/oauth/token"
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Secret payload fields</h2>
				<div className="overflow-x-auto rounded-lg border border-border bg-background/50 p-4 font-mono text-muted-foreground text-sm">
					<pre>{`{
  "apiKey": "...",
  "accessToken": "...",
  ...
  "webhookSecret": "..."
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Routing behavior</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Provider guidance</h2>
				<ul className="list-inside list-disc space-y-2 text-muted-foreground">
					<li>
