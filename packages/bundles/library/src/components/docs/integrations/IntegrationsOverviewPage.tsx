...
export function IntegrationsOverviewPage() {
	return (
		<div className="space-y-8">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Spec-first architecture</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Integration categories</h2>
  ...
  | "custom";       // User-defined`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Available integrations</h2>
				<div className="space-y-6">
					...
					{/* Open Banking */}
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">Open Banking</h3>
						<div className="grid gap-4 md:grid-cols-2">
							<Link
					...
					{/* Calendar & Scheduling */}
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">Calendar & Scheduling</h3>
						<div className="grid gap-4 md:grid-cols-2">
							<Link
					...
					{/* Storage */}
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">Storage</h3>
						<div className="grid gap-4 md:grid-cols-2">
							<Link
					...
					{/* SMS */}
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">SMS</h3>
						<div className="grid gap-4 md:grid-cols-2">
							<Link
					...
					{/* Messaging channels */}
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">Messaging channels</h3>
						<div className="grid gap-4 md:grid-cols-2">
							<Link
					...
					{/* Health */}
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">Health & wearables</h3>
						<div className="grid gap-4 md:grid-cols-2">
							<Link
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">How integrations work</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				...
				<div className="grid gap-4 md:grid-cols-2">
					<div className="card-subtle p-4">
						<h3 className="font-semibold text-xl">Environment variables</h3>
						...
						<div className="mt-3 overflow-auto rounded-lg border border-border bg-background/60 p-3 font-mono text-xs">
...
env://CONTRACTSPEC__SECRET__STRIPE`}</pre>
					...
					<div className="card-subtle p-4">
						<h3 className="font-semibold text-xl">GCP Secret Manager</h3>
						<p className="mt-2 text-muted-foreground text-sm">
...
STRIPE_SECRET_OVERRIDE=env://STRIPE_SECRET_KEY`}</pre>
  ...
  | "custom";         // Your own integrations`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Custom integrations</h2>
				<p className="text-muted-foreground">
