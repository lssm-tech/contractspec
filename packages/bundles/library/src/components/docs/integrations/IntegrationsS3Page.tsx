...
export function IntegrationsS3Page() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">S3-Compatible Storage</h1>
...
S3_REGION=fr-par`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Uploading files</h2>
				<div className="overflow-x-auto rounded-lg border border-border bg-background/50 p-4 font-mono text-muted-foreground text-sm">
...
outputs:
  ...
  etag:
    type: string`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Generating presigned URLs</h2>
				<div className="overflow-x-auto rounded-lg border border-border bg-background/50 p-4 font-mono text-muted-foreground text-sm">
