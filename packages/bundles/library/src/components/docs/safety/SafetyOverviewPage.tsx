	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Safety Overview</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Core safety features</h2>
				<div className="space-y-6">
					...
					<div className="space-y-2">
						<h3 className="font-semibold text-xl">Dark Launch & Rollback</h3>
						<p className="text-muted-foreground">
					...
					<div className="space-y-2">
						<h3 className="font-semibold text-xl">Data Classification</h3>
						<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why safety matters</h2>
				<p className="text-muted-foreground">
