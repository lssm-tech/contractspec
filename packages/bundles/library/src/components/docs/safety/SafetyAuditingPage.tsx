...
export function SafetyAuditingPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Audit Logs</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why audit logs matter</h2>
				<div className="space-y-3">
					...
					<div>
						<h3 className="font-semibold text-lg">Debugging</h3>
						<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">What ContractSpec logs</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Audit log format</h2>
				<p className="text-muted-foreground">
  ...
  "policyDecision": {
    ...
    "reason": "User has admin role"
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Storage and retention</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Querying audit logs</h2>
				<p className="text-muted-foreground">
