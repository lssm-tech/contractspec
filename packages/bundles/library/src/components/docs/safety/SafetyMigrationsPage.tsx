	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Migrations</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why migrations matter</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">How MigrationSpec works</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example MigrationSpec</h2>
				<p className="text-muted-foreground">
...
validation:
  - sql: |
    ...
    expectZeroRows: true`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Running migrations</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Rolling back migrations</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Zero-downtime migrations</h2>
				<p className="text-muted-foreground">
