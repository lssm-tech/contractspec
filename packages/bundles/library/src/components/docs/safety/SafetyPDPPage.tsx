	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Policy Decision Points</h1>
				...
				<ol className="list-inside list-decimal space-y-3 text-muted-foreground">
					...
					<li>
						...
						<ul className="mt-2 ml-6 list-inside list-disc space-y-1">
							...
							<li>
								<code className="rounded bg-background/50 px-2 py-1">DENY</code>{' '}
  ...
  - id: deny-pii-for-others
    ...
    condition: |
      ...
      field.sensitivity == 'PII'`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Performance considerations</h2>
				<p className="text-muted-foreground">
