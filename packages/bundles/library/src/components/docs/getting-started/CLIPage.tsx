	...
	return (
		<div className="space-y-8">
			<div className="space-y-2">
				<h1 className="font-bold text-4xl">ContractSpec CLI</h1>
...
contractspec validate`}
					...
					<div className="grid gap-4">
						{commands.map((cmd) => (
							<div key={cmd.name} className="card-subtle space-y-2 p-4">
								<h3 className="font-bold font-mono text-violet-400">
									{cmd.name}
								</h3>
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">CI/CD Integration</h2>
					<p className="text-muted-foreground">
