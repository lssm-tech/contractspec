	...
	return (
		<div className="space-y-8">
			<div className="space-y-2">
				<h1 className="font-bold text-4xl">Troubleshooting</h1>
			...
			<div className="space-y-6">
				<div className="card-subtle space-y-3 p-6">
					<h2 className="font-bold text-2xl">Command not found</h2>
				...
				<div className="card-subtle space-y-3 p-6">
					<h2 className="font-bold text-2xl">Specs not discovered</h2>
					<ul className="space-y-2 text-muted-foreground">
						<li>
				...
				<div className="card-subtle space-y-3 p-6">
					<h2 className="font-bold text-2xl">Build or validate fails</h2>
					<ul className="space-y-2 text-muted-foreground">
						<li>
...
contractspec validate src/contracts/mySpec.ts`}
				...
				<div className="card-subtle space-y-3 p-6">
					<h2 className="font-bold text-2xl">Still blocked?</h2>
					<ul className="space-y-2 text-muted-foreground">
						<li>
