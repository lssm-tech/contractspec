	...
	return (
		<div className="space-y-8">
			<div className="space-y-2">
				<h1 className="font-bold text-4xl">VS Code Extension</h1>
			...
			<div className="space-y-6">
				...
				<div className="space-y-4">
					<h2 className="font-bold text-2xl">Commands</h2>
						...
						{commands.map((cmd) => (
							...
							>
								<div className="flex-1">
									<p className="font-medium font-mono text-sm">{cmd.name}</p>
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Sidebar Views</h2>
					<p className="text-muted-foreground">
