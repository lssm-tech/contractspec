	...
	return (
		<div className="space-y-10">
			<div className="space-y-3">
				<h1 className="font-bold text-4xl">Guides</h1>
				...
				{guides.map((guide) => (
					...
					>
						<div className="flex items-center justify-between">
							<h2 className="font-semibold text-xl transition-colors group-hover:text-violet-400">
								{guide.title}
							</h2>
			...
			<div className="card-subtle space-y-4 p-6">
				<div className="flex items-center gap-2 font-semibold text-sm text-violet-400 uppercase tracking-[0.2em]">
					<BookOpen size={16} />
