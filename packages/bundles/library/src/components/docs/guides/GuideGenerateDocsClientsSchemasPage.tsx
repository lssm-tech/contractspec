	...
	return (
		<div className="space-y-8">
			<div className="space-y-3">
				<h1 className="font-bold text-4xl">Generate docs + client schemas</h1>
			...
			<div className="space-y-6">
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">1) Generate docs</h2>
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">2) Export OpenAPI</h2>
					<p className="text-muted-foreground text-sm">
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">3) Validate specs</h2>
					<CodeBlock
						language="bash"
