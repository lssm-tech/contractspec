	...
	return (
		<div className="space-y-8">
			...
			<div className="card-subtle space-y-4 p-6">
				<h2 className="font-bold text-2xl">Core Contract Types</h2>
					...
					{contractTypes.map((type) => (
						...
						>
							...
							<div className="space-y-1">
								...
								<code className="text-violet-400 text-xs">{type.factory}</code>
							</div>
						</div>
					))}
				</div>
...
export const GetUserQuery = defineQuery({
  ...
  policy: { auth: "user" },
				...
				{/* Events Section */}
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">2) Events</h2>
					<p className="text-muted-foreground text-sm">
  ...
  payload: new SchemaModel({
    ...
    fields: {
      ...
      reason: { type: ScalarTypeEnum.String(), isOptional: true },
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">3) Capabilities</h2>
					<p className="text-muted-foreground text-sm">
...
export const AdminUserCapability = defineCapability({
  ...
  provides: [
    ...
    { surface: "operation", key: "user.impersonate", version: "1.0.0" },
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">4) Presentations</h2>
					<p className="text-muted-foreground text-sm">
...
export const UserListPresentation = definePresentation({
  ...
  config: {
    ...
    search: { fields: ["name", "email"] },
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">5) Additional Contract Types</h2>
					<p className="text-muted-foreground text-sm">
					...
					<div className="grid gap-4 md:grid-cols-2">
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">definePolicy</code>
							<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">defineWorkflow</code>
							<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">defineTranslation</code>
							<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">defineIntegration</code>
							<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">defineFormSpec</code>
							<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">defineDataView</code>
							<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">defineFeature</code>
							<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle space-y-2 p-4">
							...
							<code className="text-violet-400 text-xs">defineTestSpec</code>
							<p className="text-muted-foreground text-xs">
				...
				{/* Registry Section */}
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">6) Registering Contracts</h2>
					<p className="text-muted-foreground text-sm">
