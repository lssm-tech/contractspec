	...
	return (
		<div className="space-y-8">
			...
			<div className="space-y-6">
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Why import existing code?</h2>
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Supported frameworks</h2>
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">1) Quick start</h2>
					<p className="text-muted-foreground text-sm">
...
contractspec import ./src --framework nestjs`}
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">2) Framework-specific patterns</h2>
					<p className="text-muted-foreground text-sm">
...
export const CreateUserCommand = defineCommand({
  ...
  transport: {
    rest: { method: "POST", path: "/users" },
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">4) Customizing imports</h2>
...
installOp(registry, CreateUserCommand, async (input) => {
  ...
  return { id: user.id };
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">6) After importing</h2>
