	...
	return (
		<div className="space-y-8">
			...
			<div className="space-y-6">
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">1) Add the CI workflow</h2>
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">2) Run CI locally</h2>
					<CodeBlock
						language="bash"
						filename="ci-local"
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">3) Add a diff check</h2>
					<p className="text-muted-foreground text-sm">
