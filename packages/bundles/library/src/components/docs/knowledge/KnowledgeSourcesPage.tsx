...
export function KnowledgeSourcesPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Knowledge Sources</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">KnowledgeSourceConfig</h2>
  ...
  updatedAt: string;
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Source types</h2>
				<div className="space-y-6">
					<div className="card-subtle p-4">
						<h3 className="mb-2 font-semibold text-lg">Uploaded Documents</h3>
  ...
  syncPolicy: { manual: true }
					...
					<div className="card-subtle p-4">
						<h3 className="mb-2 font-semibold text-lg">Notion</h3>
						<div className="overflow-x-auto rounded border border-border bg-background/50 p-3 font-mono text-muted-foreground text-xs">
							<pre>{`{
  kind: "notion",
  ...
  syncPolicy: { interval: "1h", webhook: true }
					...
					<div className="card-subtle p-4">
						<h3 className="mb-2 font-semibold text-lg">Gmail / Email</h3>
						<div className="overflow-x-auto rounded border border-border bg-background/50 p-3 font-mono text-muted-foreground text-xs">
							<pre>{`{
  kind: "email",
  ...
  syncPolicy: { webhook: true }
					...
					<div className="card-subtle p-4">
						<h3 className="mb-2 font-semibold text-lg">Database Query</h3>
						<div className="overflow-x-auto rounded border border-border bg-background/50 p-3 font-mono text-muted-foreground text-xs">
							<pre>{`{
  kind: "database-query",
  ...
  syncPolicy: { interval: "24h" }
					...
					<div className="card-subtle p-4">
						<h3 className="mb-2 font-semibold text-lg">URL / Web Scraping</h3>
						<div className="overflow-x-auto rounded border border-border bg-background/50 p-3 font-mono text-muted-foreground text-xs">
							<pre>{`{
  kind: "url",
  ...
  syncPolicy: { interval: "24h" }
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Sync strategies</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example: Multi-source space</h2>
				<p className="text-muted-foreground">
  ...
  sources: [
    ...
    },
    {
      ...
      syncPolicy: { manual: true }
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Processing pipeline</h2>
				<p className="text-muted-foreground">
