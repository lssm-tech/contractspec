...
export function KnowledgeOverviewPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Knowledge & Context</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why knowledge matters</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Knowledge architecture</h2>
				<p className="text-muted-foreground">
				...
				<div className="space-y-6">
					...
					<div className="card-subtle p-4">
						<h3 className="mb-2 font-semibold text-lg">2. Knowledge Spaces</h3>
						<p className="mb-3 text-muted-foreground text-sm">
  ...
  intendedAudience: "agents" | "humans" | "admin-only";
					...
					<div className="card-subtle p-4">
						<h3 className="mb-2 font-semibold text-lg">3. Knowledge Sources</h3>
						<p className="mb-3 text-muted-foreground text-sm">
  ...
  lastSyncedAt?: string;
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Integration with workflows</h2>
				<p className="text-muted-foreground">
      ...
      inputs: (ctx, input, steps) => ({
        messages: [
          ...
          { 
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Real-world examples</h2>
				<p className="text-muted-foreground">
