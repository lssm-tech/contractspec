...
export function KnowledgeCategoriesPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Knowledge Categories</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">The four categories</h2>
  ...
  | "ephemeral";  // Temporary context`}</pre>
			...
			<div className="space-y-6">
				<div className="space-y-4">
					<h3 className="font-semibold text-xl">1. Canonical</h3>
					<p className="text-muted-foreground">
						<strong>Trust level:</strong> Highest - Authoritative ground truth
					</p>
					<div className="space-y-3">
						<div>
							<h4 className="mb-2 font-semibold text-sm">What it contains:</h4>
						...
						<div>
							<h4 className="mb-2 font-semibold text-sm">How it's used:</h4>
							<ul className="ml-4 list-inside list-disc space-y-1 text-muted-foreground text-sm">
								<li>
						...
						<div>
							<h4 className="mb-2 font-semibold text-sm">Examples:</h4>
...
// Policy Canon space
{
  ...
  sources: [
    ...
    "compliance-requirements.md"
				...
				<div className="space-y-4">
					<h3 className="font-semibold text-xl">2. Operational</h3>
					<p className="text-muted-foreground">
...
// Internal Docs space
{
  ...
  sources: [
    ...
    "google-drive:runbooks"
				...
				<div className="space-y-4">
					<h3 className="font-semibold text-xl">3. External</h3>
					<p className="text-muted-foreground">
...
// Regulatory Docs space
{
  ...
  sources: [
    ...
    "pdf:SOC2-requirements.pdf"
				...
				<div className="space-y-4">
					<h3 className="font-semibold text-xl">4. Ephemeral</h3>
					<p className="text-muted-foreground">
...
// User Session space
{
  ...
  sources: [
    ...
    "session:form-drafts"
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Category comparison</h2>
