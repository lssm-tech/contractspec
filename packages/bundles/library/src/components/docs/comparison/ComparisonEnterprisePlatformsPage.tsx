...
export function ComparisonEnterprisePlatformsPage() {
	return (
		<div className="space-y-8">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Redwood RunMyJobs</h2>
				<p className="text-muted-foreground">
					<Link
			...
			<div className="space-y-4">
				<h3 className="font-semibold text-xl">Comparison with ContractSpec</h3>
