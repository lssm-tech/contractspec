...
export function ComparisonWorkflowEnginesPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Workflow engines</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Key differences summary</h2>
			...
			<div className="space-y-3">
				<h2 className="font-bold text-2xl">Why ContractSpec differs</h2>
