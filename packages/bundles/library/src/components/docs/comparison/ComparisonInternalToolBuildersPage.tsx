	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Internal-tool builders</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Feature comparison</h2>
			...
			<div className="space-y-3">
				<h2 className="font-bold text-2xl">ContractSpec’s differences</h2>
