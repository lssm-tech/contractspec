...
export function ComparisonWindmillPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Windmill</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Platform features</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Comparison with ContractSpec</h2>
