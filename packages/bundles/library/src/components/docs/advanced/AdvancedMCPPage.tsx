	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">MCP Adapters</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why MCP integration matters</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example: Exposing a capability</h2>
				<p className="text-muted-foreground">
...
await server.connect(transport);`}</pre>
				...
				<p className="text-muted-foreground">
					...
					execution automatically via the `OperationSpecRegistry`.
				</p>
			</div>

			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Consuming external MCP servers</h2>
				<p className="text-muted-foreground">
    ...
    output: new SchemaModel({
      ...
      fields: {
        products: { type: ScalarTypeEnum.JSON(), isOptional: false, isArray: true },
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Policy enforcement for AI agents</h2>
				<p className="text-muted-foreground">
    ...
    },
    {
      ...
      condition: (ctx, spec) => 
        ...
        !ctx.approvalGranted,
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Human-in-the-loop workflows</h2>
				<p className="text-muted-foreground">
