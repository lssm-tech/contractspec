	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Telemetry</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why telemetry matters</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Three pillars of observability</h2>
				<div className="space-y-3">
					...
					<div>
						<h3 className="font-semibold text-lg">Traces</h3>
						<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example TelemetrySpec</h2>
				<p className="text-muted-foreground">
  ...
  alerts: [
    {
      ...
      notify: ['pagerduty', 'slack'],
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Automatic instrumentation</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Sampling and performance</h2>
				<p className="text-muted-foreground">
