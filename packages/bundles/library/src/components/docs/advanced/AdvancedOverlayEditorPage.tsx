	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Overlay Editor</h1>
				<p className="text-lg text-muted-foreground">
					A Next.js app (`@contractspec/app.overlay-editor`) that lets tenant
					admins tweak field visibility, labels, and ordering, then sign
					OverlaySpecs.
				</p>
			</div>
			...
			<div className="space-y-4">
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>
						Preview JSON output powered by `@contractspec/lib.overlay-engine`.
					</li>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Provisioning flow</h2>
