	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Manifesto</h1>
			...
			<div className="space-y-6">
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Compiler, not prison</h2>
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Standard tech, no magic</h2>
					<p className="text-muted-foreground">
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Incremental adoption</h2>
					<p className="text-muted-foreground">
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">AI governance</h2>
					<p className="text-muted-foreground">
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Multi-surface consistency</h2>
					<p className="text-muted-foreground">
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Safe regeneration</h2>
					<p className="text-muted-foreground">
