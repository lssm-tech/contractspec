	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Multi-Tenancy</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Tenant Resolution</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Configuration Isolation</h2>
				<p className="text-muted-foreground">
