	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Architecture</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Core layers</h2>
				<div className="space-y-6">
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">1. Specification Layer</h3>
						<p className="text-muted-foreground">
					...
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">2. Configuration Layer</h3>
						<p className="text-muted-foreground">
					...
					<div className="space-y-3">
						<h3 className="font-semibold text-xl">3. Runtime Layer</h3>
						<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Configuration model</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Key architectural principles</h2>
