	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Control Plane Runtime</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Canonical execution loop</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Contract surfaces (v1 baseline)</h2>
				<p className="text-muted-foreground">
...
- control-plane.channel-runtime`}
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Policy and safety posture</h2>
...
implementation_plan_controle_plane.md`}
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">What comes next</h2>
				<p className="text-muted-foreground">
