...
export function SpecsOverlaysPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Overlays</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why overlays matter</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">What overlays can do</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example OverlaySpec</h2>
				<p className="text-muted-foreground">
...
signature:
  ...
  signature: "base64-encoded-signature"`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Safety guarantees</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Creating overlays</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Overlay scope</h2>
