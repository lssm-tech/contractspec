	...
	return (
		<div className="space-y-8">
			<div className="space-y-2">
				<h1 className="font-bold text-4xl">Capabilities</h1>
			...
			<div className="space-y-6">
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Defining a Command (Write)</h2>
...
export const TransferFunds = defineCommand({
  ...
  policy: {
    ...
    flags: ['payments_enabled'],
				...
				<div className="space-y-3">
					<h2 className="font-bold text-2xl">Schema Types</h2>
					<p className="text-muted-foreground">
