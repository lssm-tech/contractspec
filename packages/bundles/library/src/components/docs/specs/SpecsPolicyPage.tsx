...
export function SpecsPolicyPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Policy</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why policies matter</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Policy structure</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example PolicySpec</h2>
				<p className="text-muted-foreground">
...
export const CustomerDataAccess = definePolicy({
  ...
  rules: [
    ...
    },
    {
      ...
      redactFields: ['creditCard', 'ssn', 'bankAccount'],
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Attributes</h2>
				<p className="text-muted-foreground">
					Policy conditions can reference attributes from four categories:
				</p>
				<div className="space-y-3">
					<div>
						<h3 className="font-semibold text-lg">User attributes</h3>
						<p className="text-muted-foreground">
					...
					<div>
						<h3 className="font-semibold text-lg">Resource attributes</h3>
						<p className="text-muted-foreground">
							<code className="rounded bg-background/50 px-2 py-1">
								resource.type
							</code>
					...
					<div>
						<h3 className="font-semibold text-lg">Action attributes</h3>
						<p className="text-muted-foreground">
							<code className="rounded bg-background/50 px-2 py-1">action</code>{' '}
							(read, write, delete, execute, export, etc.)
						</p>
					</div>
					<div>
						<h3 className="font-semibold text-lg">Context attributes</h3>
						<p className="text-muted-foreground">
							<code className="rounded bg-background/50 px-2 py-1">
								time.hour
							</code>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Data classification</h2>
				<p className="text-muted-foreground">
  ...
  - name: salary
    ...
    sensitivity: confidential`}</pre>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Testing policies</h2>
				<p className="text-muted-foreground">
