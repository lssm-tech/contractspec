	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Specifications Overview</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Why spec-first matters</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Specification types</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">How specs work together</h2>
				<p className="text-muted-foreground">
