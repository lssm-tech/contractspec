...
export function SpecsWorkflowsPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Workflows</h1>
			...
			<div className="space-y-4">
				...
				<div className="space-y-3">
					...
					<div>
						<h3 className="font-semibold text-lg">Transitions</h3>
						<p className="text-muted-foreground">
					...
					<div>
						<h3 className="font-semibold text-lg">Retries</h3>
						<p className="text-muted-foreground">
					...
					<div>
						<h3 className="font-semibold text-lg">SLAs</h3>
						<p className="text-muted-foreground">
...
export const PaymentFlow = defineWorkflow({
  ...
  sla: {
    ...
    alertOnBreach: true,
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Triggers</h2>
				<p className="text-muted-foreground">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Monitoring and versioning</h2>
				<p className="text-muted-foreground">
