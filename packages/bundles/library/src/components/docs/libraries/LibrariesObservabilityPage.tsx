	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Observability Library</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Tracing</h2>
				<CodeBlock
					language="typescript"
...
latencyHistogram.record(0.123);`}
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Middleware</h2>
...
app.use(createTracingMiddleware());`}
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Anomaly Detection</h2>
