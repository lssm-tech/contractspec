	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Multi-Tenancy Library</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Prisma RLS Middleware</h2>
...
prisma.$use(createRlsMiddleware(() => getTenantId()));`}
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Provisioning Service</h2>
				<p className="text-muted-foreground">
