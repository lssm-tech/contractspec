	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">@contractspec/lib.analytics</h1>
			...
			<div className="space-y-3">
				<h2 className="font-bold text-2xl">Funnels in memory</h2>
				<CodeBlock
					language="typescript"
...
const report = analyzer.analyze(events, {
  ...
  steps: [
    ...
    { id: 'verified', eventName: 'account.verified' },
			...
			<div className="space-y-3">
				<h2 className="font-bold text-2xl">Cohorts & churn</h2>
				<CodeBlock
					language="typescript"
...
const churn = new ChurnPredictor().score(events);`}
			...
			<div className="space-y-3">
				<h2 className="font-bold text-2xl">Growth hypotheses</h2>
				<CodeBlock
					language="typescript"
