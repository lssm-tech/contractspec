	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">@contractspec/lib.schema</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Core Exports</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example: Basic Schema</h2>
				<CodeBlock
					language="typescript"
...
const jsonSchema = CreateSpotInput.getJsonSchema();`}
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Example: Enums</h2>
				<CodeBlock
					language="typescript"
...
const RecurrenceRule = new SchemaModel({
  ...
  fields: {
    ...
    byWeekday: { type: Weekday, isOptional: true, isArray: true },
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Available Scalars</h2>
