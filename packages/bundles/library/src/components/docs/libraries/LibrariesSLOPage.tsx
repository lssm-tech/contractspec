...
export function LibrariesSLOPage() {
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">SLO Library</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Define Targets</h2>
				<CodeBlock
					language="typescript"
  ...
  alerts: { fastBurnThreshold: 14, slowBurnThreshold: 6 },
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Monitor Burn Rate</h2>
				<CodeBlock
					language="typescript"
...
const { snapshot, burnRate } = monitor.recordWindow({
  ...
  latencyP95: 210,
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">History & Reporting</h2>
				<p className="text-muted-foreground text-sm">
