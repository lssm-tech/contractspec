	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Cost Tracking Library</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Record Samples</h2>
				<CodeBlock
					language="typescript"
...
tracker.recordSample({
  ...
  externalCalls: [{ provider: 'stripe', cost: 0.02 }],
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Budget Alerts</h2>
				<CodeBlock
					language="typescript"
...
tracker.getTotals({ tenantId: 'acme' }).forEach((summary) => budgets.track(summary));`}
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Optimization Suggestions</h2>
