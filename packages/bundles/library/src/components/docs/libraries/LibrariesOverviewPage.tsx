	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">Libraries Overview</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Core Libraries</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">UI Libraries</h2>
				<div className="grid gap-4 md:grid-cols-2">
					<Link
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Data & Backend</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">GraphQL</h2>
				<div className="grid gap-4 md:grid-cols-3">
					<div className="card-subtle p-4">
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Philosophy</h2>
				<p className="text-muted-foreground">
