	...
	return (
		<div className="space-y-8">
			<div className="space-y-4">
				<h1 className="font-bold text-4xl">@contractspec/lib.contracts-spec</h1>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">What lives where</h2>
...
export const CreateUser = defineCommand({
  ...
  policy: { auth: 'admin' },
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Lifecycle</h2>
			...
			<div className="space-y-4">
				<h2 className="font-bold text-2xl">Adapters</h2>
