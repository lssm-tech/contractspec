		...
		<main className="flex grow flex-col items-center justify-center pt-24">
			<section className="section-padding">
				<div className="prose prose-invert mx-auto max-w-3xl">
					<h1 className="mb-4 font-bold text-4xl">Terms of Service</h1>
					...
					<section className="mt-10 space-y-4">
						...
						<div className="rounded-lg border border-white/10 bg-white/5 p-4 text-muted-foreground">
					...
					{/* 5. Accounts */}
					<section className="mt-10 space-y-4">
						<h2 className="font-bold text-2xl text-foreground">5. Accounts</h2>
						<div className="rounded-lg border border-yellow-500/20 bg-yellow-500/5 p-4 text-muted-foreground">
					...
					<section className="mt-10 space-y-4">
						...
						<div className="rounded-lg border border-orange-500/20 bg-orange-500/5 p-4 text-muted-foreground">
					...
					{/* 16. Contact */}
					<section className="mt-10 space-y-4">
						<h2 className="font-bold text-2xl text-foreground">16. Contact</h2>
						<p className="text-muted-foreground">
