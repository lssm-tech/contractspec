 ...
 */
function generateCrmPipelineCanvas(components: {
  list: string;
  detail: string;
  dashboard?: string;
}): ComponentNode[] {
 ...
 */
function generateSaasBoilerplateCanvas(components: {
  list: string;
  detail: string;
  dashboard?: string;
}): ComponentNode[] {
 ...
 */
function generateAgentConsoleCanvas(components: {
  list: string;
  detail: string;
  dashboard?: string;
}): ComponentNode[] {
 ...
 */
function generateTodosCanvas(components: {
  list: string;
  detail: string;
}): ComponentNode[] {
  return [
 ...
 */
function generateMessagingCanvas(components: {
  list: string;
  detail: string;
}): ComponentNode[] {
  return [
 ...
 */
function generateRecipeCanvas(components: {
  list: string;
  detail: string;
}): ComponentNode[] {
  return [
 ...
 */
function generateDefaultCanvas(components: {
  list: string;
  detail: string;
}): ComponentNode[] {
  return [
