...
declare module '@lssm/lib.contracts' {
...
declare module '@lssm/lib.contracts/types/all' {
  export * from '@lssm/lib.contracts';
}

declare global {
  const contractSpec: typeof import('@lssm/lib.contracts').contractSpec;
  const defineCapability: typeof import('@lssm/lib.contracts').defineCapability;
}
