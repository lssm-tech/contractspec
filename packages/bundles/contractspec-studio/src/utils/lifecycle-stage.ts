...
const LIFECYCLE_TO_PRISMA: Record<LifecycleStage, PrismaLifecycleStage> = {
  ...
  [LifecycleStage.MvpEarlyTraction]:
    PrismaLifecycleStage.MVP_EARLY_TRACTION,
  [LifecycleStage.ProductMarketFit]:
    PrismaLifecycleStage.PRODUCT_MARKET_FIT,
  [LifecycleStage.GrowthScaleUp]: PrismaLifecycleStage.GROWTH_SCALE_UP,
  [LifecycleStage.ExpansionPlatform]:
    PrismaLifecycleStage.EXPANSION_PLATFORM,
  [LifecycleStage.MaturityRenewal]:
    PrismaLifecycleStage.MATURITY_OPTIMIZATION,
};
