...
import { generateHandlerTemplate, generateComponentTemplate, generateTestTemplate } from './handler.template';
...
describe('Handler Template', () => {
  describe('generateHandlerTemplate', () => {
    it('should generate a command handler', () => {
      ...
      expect(code).toContain("import { CommandSpec } from '../contracts/my-awesome-command.contracts'");
      expect(code).toContain('export const commandHandler: ContractHandler<typeof CommandSpec>');
  ...
  describe('generateTestTemplate', () => {
    it('should generate a handler test', () => {
      ...
      expect(code).toContain("import { MyHandler } from '../handlers/my-handler'");
