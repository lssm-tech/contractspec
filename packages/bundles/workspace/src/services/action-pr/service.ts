// import { formatAge } from '../../services/ci-check/utils'; // Not found, implementing locally
// import fnmatch from 'fnmatch'; // Not available, using regex
...
export class PrActionService {
  ...
  private deriveImpactStatus(
    impactJson: ImpactJson | undefined
  ): {
    status: string;
    breaking: boolean;
