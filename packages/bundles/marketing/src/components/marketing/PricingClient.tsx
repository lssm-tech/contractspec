				...
				<div className="mx-auto max-w-6xl">
					<div className="grid gap-6 md:grid-cols-3">
						...
						<div className="card-subtle col-span-3 space-y-6 border-violet-500/20 p-6">
							<div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-violet-500 px-3 py-1 font-medium text-white text-xs">
								<div className="font-bold text-1xl">Free Forever</div>
							...
							<div className="flex flex-row justify-around">
								<div className="w-1/2">
									<div className="space-y-2">
										<h2 className="font-bold text-2xl">OSS Core</h2>
									</div>
									<p className="text-muted-foreground text-sm">
						...
						<div className="card-subtle relative space-y-6 bg-violet-500/5 p-6 ring-2 ring-violet-500">
							...
							<div className="space-y-2">
								<h2 className="font-bold text-2xl">Design Partner</h2>
								<div className="space-y-1">
									<div className="font-bold text-2xl">Invite-based</div>
									<p className="text-muted-foreground text-xs">
						...
						<div className="card-subtle relative space-y-6 p-6">
							<div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full border border-border bg-muted px-3 py-1 font-medium text-xs">
								Coming soon
							</div>
							<div className="space-y-2">
								<h2 className="font-bold text-2xl">Builder</h2>
								<div className="space-y-1">
						...
						<div className="card-subtle relative space-y-6 p-6">
							...
							<div className="space-y-2">
								<h2 className="font-bold text-2xl">Team & Platform</h2>
								<div className="space-y-1">
									<div className="font-bold text-2xl">
			...
			<section className="section-padding border-border border-b">
				<div className="mx-auto max-w-3xl space-y-8">
					...
					<div className="pt-4 text-center">
						<p className="mb-2 text-muted-foreground text-sm">Still unsure?</p>
						<Link
							href="/contact"
							className="font-medium text-sm text-violet-400 hover:text-violet-300"
						>
							Contact us →
						</Link>
					</div>
