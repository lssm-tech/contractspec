	...
	return (
		<MarketingSection tone="gradient" padding="spacious" align="center">
			<VStack gap="lg" align="center" className="text-center">
				...
				<Lead className="max-w-2xl text-balance text-lg text-muted-foreground md:text-xl">
...
function WhatExistsSection() {
	...
	return (
		<MarketingSection padding="comfortable" align="center" maxWidth="lg">
			<VStack gap="lg">
				<H2 className="font-bold text-3xl">What exists today</H2>
				<div className="grid w-full gap-8 md:grid-cols-2">
					<VStack gap="sm" align="start">
						<H3 className="font-semibold text-emerald-400 text-lg">Real now</H3>
					...
					<VStack gap="sm" align="start">
						<H3 className="font-semibold text-blue-400 text-lg">Planned</H3>
						<ul className="space-y-2">
							{planned.map((item) => (
								<li key={item} className="flex items-start gap-2">
...
function RoleSection() {
	...
	return (
		...
		>
			<VStack gap="lg">
				<H2 className="font-bold text-3xl">The role</H2>
				...
				<VStack gap="md" align="start" className="w-full pt-4">
					<H3 className="font-semibold text-xl">Option B: Product / Design</H3>
...
function IdealCofounderSection() {
	...
	return (
		<MarketingSection padding="comfortable" align="center" maxWidth="lg">
			<VStack gap="lg">
				<H2 className="font-bold text-3xl">The ideal co-founder</H2>
				...
				<Box className="mt-4 rounded-lg border border-border p-4">
					<VStack gap="sm" align="start">
						<H3 className="font-semibold text-lg">Proof of work examples</H3>
...
function WhatYouGetSection() {
	...
	return (
		...
		>
			<VStack gap="lg">
				<H2 className="font-bold text-3xl">What you get</H2>
...
function RedFlagsSection() {
	...
	return (
		<MarketingSection padding="comfortable" align="center" maxWidth="lg">
			<VStack gap="lg">
				<H2 className="font-bold text-3xl">Non-negotiables / red flags</H2>
	...
	return (
		...
		>
			<VStack gap="md" align="center" className="text-center">
				<H2 className="font-bold text-3xl md:text-4xl">Ready to talk?</H2>
