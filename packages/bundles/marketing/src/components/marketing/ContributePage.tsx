		...
		<main className="flex grow flex-col items-center justify-center">
			<section className="section-padding">
				<div className="prose prose-invert mx-auto max-w-2xl">
					...
					{/* Quick Start Box */}
					<div className="not-prose mb-12 rounded-lg border border-border bg-muted/30 p-6">
					...
					{/* Quality Bar */}
					<section className="mb-10 space-y-4">
						<h2 className="font-bold text-2xl text-foreground">Quality Bar</h2>
						...
						<div className="mt-4 rounded-md bg-muted/20 p-4">
					...
					<section className="mb-10 space-y-4" id="security">
						<h2 className="font-bold text-2xl text-foreground">Security</h2>
						<p className="text-muted-foreground">
					...
					{/* Go Deeper */}
					<section className="mt-12 space-y-4 border-border border-t pt-8">
						<h2 className="font-bold text-2xl text-foreground">
							Want to Go Deeper?
						</h2>
						<p className="text-muted-foreground">
