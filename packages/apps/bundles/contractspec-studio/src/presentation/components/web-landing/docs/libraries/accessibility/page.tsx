  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        <h1 className="text-4xl font-bold">@lssm/lib.accessibility</h1>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-background/50 border-border text-muted-foreground overflow-x-auto rounded-lg border p-4 font-mono text-sm">
          <pre>{`npm install @lssm/lib.accessibility
# or
bun add @lssm/lib.accessibility`}</pre>
        </div>
      </div>
  ...
  return (
    <html lang="en">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-background/50 border-border text-muted-foreground overflow-x-auto rounded-lg border p-4 font-mono text-sm">
          <pre>{`import { useSRLiveRegion } from '@lssm/lib.accessibility';
