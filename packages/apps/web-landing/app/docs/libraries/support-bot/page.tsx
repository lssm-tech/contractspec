...
export const metadata: Metadata = {
  ...
  description: 'Resolve tickets with classification, RAG, auto-response, and feedback loops.',
};
    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-lg">
          Build AI-first support flows using drop-in classifiers, knowledge-grounded resolvers, and
          tone-aware responders—all wired into the agent runner.
        </p>
      </div>
...
const executor = new ToolExecutor({ tools });`}
      ...
      <div className="space-y-3">
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          <li><strong>TicketClassifier</strong>: heuristics + optional LLM validation for category/priority.</li>
          <li><strong>TicketResolver</strong>: RAG resolver that can plug into any knowledge retriever.</li>
          <li><strong>AutoResponder</strong>: generates drafts, citations, and tone-aware copy.</li>
          <li><strong>SupportFeedbackLoop</strong>: track auto-resolution rates and sentiment trends.</li>
        </ul>
      </div>
    </div>
  );
