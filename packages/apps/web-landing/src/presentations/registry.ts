...
import ProductClientPage from '@/app/(landing-marketing)/product/product-client';
import PricingClient from '@/app/(landing-marketing)/pricing/pricing-client';
import ContactClient from '@/app/(landing-marketing)/contact/contactClient';
import ChangelogPage from '@/app/(landing-marketing)/changelog/page';
