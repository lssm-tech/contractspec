    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <pre className="bg-muted rounded-lg border p-4 text-sm">
          {`import { SpecExperimentRegistry } from '@lssm/lib.growth/spec-experiments';
...
const registry = new SpecExperimentRegistry().register({
  ...
  guardrails: { errorRateThreshold: 0.02, latencyP99ThresholdMs: 500 },
      ...
      <div className="space-y-3">
        ...
        <pre className="bg-muted rounded-lg border p-4 text-sm">
          {`import { createSpecVariantResolver } from '@lssm/lib.growth/spec-experiments';
...
} from '@lssm/lib.growth/spec-experiments';
