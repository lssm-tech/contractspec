    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-lg">
          The <code>@lssm/lib.contracts/data-views</code> and{' '}
          <code>@lssm/lib.design-system</code> libraries provide the runtime
          logic and UI components to render DataViews in your application.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <pre className="bg-muted rounded-lg border p-4">
          <code>npm install @lssm/lib.contracts @lssm/lib.design-system</code>
        </pre>
      </div>
