...
function QualityBadge({ score }: { score: number }) {
	...
	return (
		<span className={`rounded px-1.5 py-0.5 font-medium text-xs ${badge.cls}`}>
			{badge.label}
		</span>
	);
}
...
export function PackCard({ pack }: PackCardProps) {
	...
	return (
		<Link
			...
			className="card-subtle group flex flex-col rounded-lg border border-border p-4 transition-colors hover:border-primary/50"
		>
