		...
		<div className="section-padding">
			<div className="mx-auto max-w-6xl">
				...
				<div className="mb-8 text-center">
					<h1 className="font-bold text-3xl tracking-tight">Featured Packs</h1>
					...
					<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
						{packs.map((pack) => (
							<Link
								...
								className="card-subtle group flex flex-col rounded-xl border border-border p-6 transition-all hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5"
							>
