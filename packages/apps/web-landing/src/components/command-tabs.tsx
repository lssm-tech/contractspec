  ...
  return (
    ...
    >
      <div className="flex items-center border-b border-zinc-800 bg-zinc-900/50 px-2 pt-2">
        {packageManagers.map((pm) => (
          <button
            ...
            className={cn(
              'rounded-t-md border-t border-r border-l border-transparent px-4 py-2 text-xs font-medium text-zinc-400 hover:text-zinc-100',
      ...
      <div className="relative p-4">
        ...
        <pre className="overflow-x-auto font-mono text-[13px] leading-6 text-white">
