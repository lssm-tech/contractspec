...
- Updated dependencies because of Add provider delta contracts, Google Drive knowledge ingestion, and governed mutation execution for workspace knowledge.
  ...
  - @contractspec/integration.provider.claude-code@0.2.10
  - @contractspec/integration.provider.codex@0.2.10
  - @contractspec/integration.provider.copilot@0.2.10
  - @contractspec/integration.provider.gemini@0.2.10
  - @contractspec/integration.provider.local-model@0.2.10
  - @contractspec/integration.provider.stt@0.2.10
  - @contractspec/integration.runtime.hybrid@0.2.11
  - @contractspec/integration.runtime.local@0.2.11
  ...
  - @contractspec/lib.progressive-delivery@34.0.28
  ...
  - @contractspec/module.mobile-review@0.2.15
...
- Updated dependencies because of Improve PageOutline desktop behavior with a Notion-like floating rail, and hide the AppShell page outline on small web screens to preserve layout stability.
  ...
  - @contractspec/module.mobile-review@0.2.14
...
- Updated dependencies because of Forward refs through the web Button primitive and its slotted rendering path to stabilize Radix `asChild` triggers.
  ...
  - @contractspec/integration.provider.claude-code@0.2.6
  - @contractspec/integration.provider.codex@0.2.6
  - @contractspec/integration.provider.copilot@0.2.6
  - @contractspec/integration.provider.gemini@0.2.6
  - @contractspec/integration.provider.local-model@0.2.6
  - @contractspec/integration.provider.stt@0.2.6
  - @contractspec/integration.runtime.hybrid@0.2.7
  - @contractspec/integration.runtime.local@0.2.7
  - @contractspec/integration.runtime.managed@0.2.7
  - @contractspec/lib.ai-providers@3.7.18
  - @contractspec/lib.builder-spec@0.2.7
  - @contractspec/lib.example-shared-ui@7.0.4
  - @contractspec/lib.progressive-delivery@34.0.24
...
- Updated dependencies because of Expand ContractSpec authoring with preset-driven workspace setup, shell completion, packaged workspace schema artifacts, and richer form and UI surfaces across the CLI, editors, and shared runtimes.
  ...
  - @contractspec/integration.runtime.hybrid@0.2.1
  - @contractspec/integration.runtime.local@0.2.1
  - @contractspec/integration.runtime.managed@0.2.1
  - @contractspec/lib.progressive-delivery@34.0.18
...
- Updated dependencies [2b59171]
  ...
  - @contractspec/lib.progressive-delivery@34.0.15
...
- Updated dependencies [cce2b13]
  ...
  - @contractspec/lib.progressive-delivery@34.0.14
  ...
  - @contractspec/bundle.marketing@3.8.8
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@34.0.11
  ...
  - @contractspec/bundle.marketing@3.8.3
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@34.0.6
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@34.0.4
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@34.0.3
  ...
  - @contractspec/bundle.marketing@3.7.3
...
- Updated dependencies [04bc555]
  ...
  - @contractspec/lib.progressive-delivery@34.0.2
  ...
  - @contractspec/bundle.marketing@3.7.2
...
- Updated dependencies [f88df2d]
  ...
  - @contractspec/lib.progressive-delivery@34.0.0
  ...
  - @contractspec/example.in-app-docs@3.7.0
...
- Updated dependencies [f5d4816]
  ...
  - @contractspec/lib.progressive-delivery@32.0.4
  ...
  - @contractspec/example.in-app-docs@3.5.4
...
- Updated dependencies [56ae36d]
  ...
  - @contractspec/lib.progressive-delivery@32.0.3
  ...
  - @contractspec/example.in-app-docs@3.5.3
  ...
  - @contractspec/bundle.marketing@3.5.3
...
- Updated dependencies [18df977]
  ...
  - @contractspec/lib.progressive-delivery@32.0.2
...
- Updated dependencies [73a7f8d]
  ...
  - @contractspec/lib.progressive-delivery@32.0.1
  ...
  - @contractspec/example.in-app-docs@3.5.1
...
- Updated dependencies [8f47829]
  ...
  - @contractspec/lib.progressive-delivery@31.0.1
  ...
  - @contractspec/example.in-app-docs@3.4.1
  ...
  - @contractspec/bundle.marketing@3.4.1
...
- Updated dependencies
  - @contractspec/bundle.library@2.7.0
  - @contractspec/bundle.marketing@2.7.0
  ...
  - @contractspec/example.in-app-docs@2.7.0
  ...
  - @contractspec/lib.progressive-delivery@24.0.0
...
- Updated dependencies [f8dc3ad]
  ...
  - @contractspec/example.in-app-docs@2.6.1
...
- Updated dependencies [bae3db1]
  ...
  - @contractspec/bundle.marketing@2.6.0
  ...
  - @contractspec/example.in-app-docs@2.6.0
  ...
  - @contractspec/lib.progressive-delivery@23.0.0
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@21.0.0
...
- Updated dependencies [12c9556]
  ...
  - @contractspec/lib.progressive-delivery@20.0.0
  ...
  - @contractspec/example.in-app-docs@2.3.0
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@19.0.0
  ...
  - @contractspec/example.in-app-docs@2.2.0
...
- Updated dependencies [57e2819]
  ...
  - @contractspec/bundle.marketing@2.1.1
  ...
  - @contractspec/example.in-app-docs@2.1.1
  ...
  - @contractspec/lib.progressive-delivery@18.0.1
...
- Updated dependencies [659d15f]
  ...
  - @contractspec/lib.progressive-delivery@18.0.0
...
- Updated dependencies [064258d]
  ...
  - @contractspec/lib.progressive-delivery@16.0.0
  ...
  - @contractspec/example.in-app-docs@1.9.0
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@10.0.1
  ...
  - @contractspec/example.in-app-docs@1.3.1
...
- Updated dependencies
  ...
  - @contractspec/lib.progressive-delivery@10.0.0
  ...
  - @contractspec/example.in-app-docs@1.3.0
...
- Updated dependencies [d93e6a9]
  ...
  - @contractspec/lib.progressive-delivery@6.0.0
...
- Updated dependencies [b0444a4]
  ...
  - @contractspec/lib.progressive-delivery@2.0.0
...
- Updated dependencies [fd38e85]
  ...
  - @contractspec/lib.progressive-delivery@1.47.0
...
- Updated dependencies
  - @contractspec/bundle.studio@0.4.0
  - @contractspec/lib.database-studio@0.4.0
...
- Updated dependencies
  - @contractspec/bundle.studio@0.3.1
  - @contractspec/lib.database-studio@0.3.1
  - @contractspec/lib.design-system@1.11.1
  - @contractspec/lib.progressive-delivery@3.0.1
...
- Updated dependencies [b1d0876]
  - @contractspec/bundle.studio@0.1.0
  - @contractspec/lib.progressive-delivery@1.0.0
...
- `@contractspec/lib.progressive-delivery` – strategies, controllers, traffic shifting, rollback manager
- `@contractspec/lib.slo` – definitions, tracker, burn-rate monitor, incident integration
- `@contractspec/lib.cost-tracking` – sample attribution, budgets, optimization recommender
- `@contractspec/lib.observability` – anomaly toolkit (baseline calculator, detector, root-cause analyzer, alert manager)
...
- `@contractspec/lib.overlay-engine` – spec runtime, signing, validator, React hooks
- `@contractspec/lib.personalization` – behavior tracker, analyzer, adapter
- `@contractspec/lib.workflow-composer` – tenant workflow extensions
- `@contractspec/app.overlay-editor` – drag-and-drop overlay builder with signing
...
- `@contractspec/lib.evolution` – spec analyzer, generator, approval integration
- `@contractspec/lib.observability` – intent detector + evolution pipeline hooks
- `@contractspec/lib.growth/spec-experiments` – staged rollouts, guardrails, auto-rollback
- `@contractspec/lib.testing` – traffic recorder + golden test generator/adapters
...
- `@contractspec/lib.ai-agent` – agent runtime, memory, and approval workflow
- `@contractspec/lib.support-bot` – classifier, RAG resolver, auto-responder, tool wiring
- `@contractspec/lib.content-gen` – blog/landing/email/social generators plus SEO tooling
- `@contractspec/lib.analytics` – funnels, cohorts, churn, and hypotheses
- `@contractspec/lib.growth` – experiments, stats engine, tracker
- `@contractspec/lib.design-system` – ApprovalQueue + AgentMonitor UI for human-in-the-loop reviews
...
- `@contractspec/lib.multi-tenancy` - Tenant isolation and provisioning
- `@contractspec/lib.observability` - OpenTelemetry integration
- `@contractspec/lib.resilience` - Circuit breakers and resilience patterns
