...
- Updated dependencies because of chore: auto-bump internal dependents
  ...
  - @contractspec/example.video-api-showcase@3.7.32
  - @contractspec/example.video-docs-terminal@3.7.32
...
- Updated dependencies because of Teach the Integration Hub example to model managed/BYOK credential setup and monorepo-aware env aliases.
  ...
  - @contractspec/example.meeting-recorder-providers@3.7.29
  ...
  - @contractspec/example.video-api-showcase@3.7.31
  - @contractspec/example.video-docs-terminal@3.7.31
  - @contractspec/example.visualization-showcase@3.9.23
  - @contractspec/example.voice-providers@3.7.29
  - @contractspec/example.workflow-system@3.8.23
  - @contractspec/lib.presentation-runtime-core@5.2.2
  - @contractspec/lib.presentation-runtime-react-native@40.0.2
...
- Updated dependencies because of Split example discovery from rich runtime packages so lightweight consumers no longer install every ContractSpec example.
  ...
  - @contractspec/example.video-api-showcase@3.7.23
  - @contractspec/example.video-docs-terminal@3.7.23
  - @contractspec/example.visualization-showcase@3.9.15
  - @contractspec/example.workflow-system@3.8.15
  - @contractspec/lib.presentation-runtime-react-native@38.0.1
  - @contractspec/lib.ui-kit@4.0.0
  - @contractspec/example.voice-providers@3.7.22
  - @contractspec/example.meeting-recorder-providers@3.7.22
