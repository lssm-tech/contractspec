...
/**
 * Canonical library schema contribution for notifications.
 */
export const notificationsSchemaContribution: ModuleSchemaContribution = {
	moduleId: '@contractspec/lib.notification',
...
/**
 * Legacy module schema contribution for compatibility shims.
 */
export const legacyNotificationsSchemaContribution: ModuleSchemaContribution = {
