...
export function CommandTabs({
	...
	return (
		...
		>
			<div
				className="flex items-center border-zinc-800 border-b bg-zinc-900/50 px-2 pt-2"
				role="tablist"
			...
			>
				{packageManagers.map((pm) => (
					<button
						...
						className={cn(
							'rounded-t-md border-transparent border-t border-r border-l px-4 py-2 font-medium text-xs text-zinc-400',
			...
			<div className="relative p-4" role="tabpanel">
				<CopyButton
					...
					onCopy={handleCopy}
				/>
				<pre className="overflow-x-auto pr-10 font-mono text-[13px] text-white leading-6">
