...
The package currently exposes **435 subpath exports**. This map is auto-generated for high-context navigation and AI grounding.
...
- `agent`: `capability(1)`, `feature(1)`, `command(3)`, `event(4)`, `query(2)`, `form(1)`, `presentation(1)`, `dataView(1)`, `plain(13)`
...
- `presentations`: `docblock(1)`, `plain(3)`
