...
const ModelProfileOutput = new SchemaModel({
  ...
  fields: {
    ...
    costPerMillionInput: { type: ScalarTypeEnum.Float(), isOptional: true },
    costPerMillionOutput: { type: ScalarTypeEnum.Float(), isOptional: true },
    capabilities: { type: ScalarTypeEnum.String_unsecure(), isOptional: false, isArray: true },
    compositeScore: { type: ScalarTypeEnum.Float(), isOptional: true },
