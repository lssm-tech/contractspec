...
\`\`\`ts
import { createCapabilityContext, assertCapabilityForOperation } from '@contractspec/lib.contracts-spec';
...
\`\`\`ts
import { validateCapabilityConsistency, findOrphanSpecs } from '@contractspec/lib.contracts-spec';
...
\`\`\`ts
import { CapabilityMissingError } from '@contractspec/lib.contracts-spec';
