			...
			<DialogOverlay>
				...
				>
					...
					<DialogPrimitive.Close
						className={
							'web:group absolute top-4 right-4 rounded-xs p-0.5 opacity-70 web:ring-offset-background web:transition-opacity web:hover:opacity-100 web:focus:outline-hidden web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2 web:disabled:pointer-events-none'
						}
					>
						<X
