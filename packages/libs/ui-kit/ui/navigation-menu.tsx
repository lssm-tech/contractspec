...
function NavigationMenuViewport({
	...
	return (
		<View className={cn('absolute top-full left-0 flex justify-center')}>
			<View
				className={cn(
					'web:zoom-in-90 relative mt-1.5 web:h-(--radix-navigation-menu-viewport-height) w-full web:origin-top-center web:animate-in overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-lg',
					className
				)}
				{...props}
			>
