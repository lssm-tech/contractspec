...
export const UserEntity = defineEntity({
  ...
  fields: {
    ...
    emailVerified: field.boolean({ default: false, description: 'Whether email has been verified' }),
    ...
    locale: field.string({ isOptional: true, description: 'User locale (e.g., "en-US")' }),
    timezone: field.string({ isOptional: true, description: 'Olson timezone (e.g., "Europe/Paris")' }),
    imageUrl: field.url({ isOptional: true, description: 'URL of avatar or profile picture' }),
    image: field.string({ isOptional: true, description: 'Legacy image field' }),
    metadata: field.json({ isOptional: true, description: 'Arbitrary user metadata' }),
    
    // Onboarding
    onboardingCompleted: field.boolean({ default: false, description: 'Whether onboarding is complete' }),
    onboardingStep: field.string({ isOptional: true, description: 'Current onboarding step' }),
    whitelistedAt: field.dateTime({ isOptional: true, description: 'When user was whitelisted' }),
    
    // Admin fields
    role: field.string({ isOptional: true, default: '"user"', description: 'User role (user, admin)' }),
    banned: field.boolean({ default: false, description: 'Whether user is banned' }),
    banReason: field.string({ isOptional: true, description: 'Reason for ban' }),
    banExpires: field.dateTime({ isOptional: true, description: 'When ban expires' }),
    
    // Phone authentication
    phoneNumber: field.string({ isOptional: true, isUnique: true, description: 'Phone number' }),
    phoneNumberVerified: field.boolean({ default: false, description: 'Whether phone is verified' }),
...
export const SessionEntity = defineEntity({
  ...
  fields: {
    ...
    ipAddress: field.string({ isOptional: true, description: 'Client IP address' }),
    userAgent: field.string({ isOptional: true, description: 'Client user agent' }),
    impersonatedBy: field.string({ isOptional: true, description: 'Admin impersonating this session' }),
    activeOrganizationId: field.string({ isOptional: true, description: 'Active org context' }),
    activeTeamId: field.string({ isOptional: true, description: 'Active team context' }),
    createdAt: field.createdAt(),
    updatedAt: field.updatedAt(),
...
export const AccountEntity = defineEntity({
  ...
  fields: {
    ...
    password: field.string({ isOptional: true, description: 'Hashed password for password providers' }),
    createdAt: field.createdAt(),
    updatedAt: field.updatedAt(),
  ...
  indexes: [
    index.unique(['accountId', 'providerId']),
  ],
});
