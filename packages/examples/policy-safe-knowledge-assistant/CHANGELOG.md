...
- Updated dependencies because of Improve PageOutline desktop behavior with a Notion-like floating rail that keeps AppShell content centered while expanding on hover or keyboard focus.
  - @contractspec/example.kb-update-pipeline@3.7.28
  - @contractspec/example.learning-patterns@4.0.8
  - @contractspec/example.locale-jurisdiction-gate@3.7.28
  - @contractspec/example.versioned-knowledge-base@3.7.28
...
- Updated dependencies because of Render resolver-backed combobox results as a floating overlay instead of inline form content.
  ...
  - @contractspec/example.kb-update-pipeline@3.7.26
  - @contractspec/example.learning-patterns@4.0.6
  - @contractspec/example.locale-jurisdiction-gate@3.7.26
  - @contractspec/example.versioned-knowledge-base@3.7.26
...
- Updated dependencies because of Forward refs through the web Button primitive and its slotted rendering path to stabilize Radix `asChild` triggers.
  - @contractspec/example.kb-update-pipeline@3.7.25
  - @contractspec/example.learning-patterns@4.0.5
  - @contractspec/example.locale-jurisdiction-gate@3.7.25
  - @contractspec/example.versioned-knowledge-base@3.7.25
...
- Updated dependencies because of Add OSS harness CLI verification with deterministic Playwright, optional agent-browser visual runs, auth profile refs, visual diff evidence, replay bundles, and core scenario success semantics.
  - @contractspec/example.kb-update-pipeline@3.7.24
  - @contractspec/example.learning-patterns@4.0.4
  - @contractspec/example.locale-jurisdiction-gate@3.7.24
  - @contractspec/example.versioned-knowledge-base@3.7.24
...
- Updated dependencies because of Add a unified design-system Tabs primitive and migrate local tab consumers away from ui-kit leaf imports.
  - @contractspec/example.kb-update-pipeline@3.7.23
  - @contractspec/example.learning-patterns@4.0.3
  - @contractspec/example.locale-jurisdiction-gate@3.7.23
  - @contractspec/example.versioned-knowledge-base@3.7.23
...
- Updated dependencies because of Centralize repeated dependency specs through Bun catalogs and align React Hook Form/Zod resolver types after dependency upgrades.
  - @contractspec/example.kb-update-pipeline@3.7.22
  - @contractspec/example.learning-patterns@4.0.2
  - @contractspec/example.locale-jurisdiction-gate@3.7.22
  - @contractspec/example.versioned-knowledge-base@3.7.22
