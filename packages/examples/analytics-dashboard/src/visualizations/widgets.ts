...
const LEGACY_VISUALIZATION_REFS: Partial<Record<Widget['type'], VisualizationRef>> = {
...
function isAnalyticsWidgetConfig(value: unknown): value is AnalyticsWidgetConfig {
