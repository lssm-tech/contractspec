...
export const RevenueMetricVisualization = defineVisualization({
  ...
  visualization: {
    ...
    dimensions: [{ key: 'period', label: 'Period', dataPath: 'period', type: 'time' }],
    measures: [
      {
        key: 'totalRevenue',
        label: 'Revenue',
...
export const RevenueTrendVisualization = defineVisualization({
  ...
  visualization: {
    ...
    xDimension: 'date',
    yMeasures: ['revenue'],
    dimensions: [{ key: 'date', label: 'Month', dataPath: 'date', type: 'time' }],
    measures: [
      {
        key: 'revenue',
        label: 'Revenue',
    ...
    thresholds: [{ key: 'target', value: 140000, label: 'Target', color: '#dc2626' }],
...
export const RetentionAreaVisualization = defineVisualization({
  ...
  visualization: {
    ...
    thresholds: [{ key: 'floor', value: 0.5, label: 'Floor', color: '#f59e0b' }],
...
export const PipelineScatterVisualization = defineVisualization({
  ...
  visualization: {
    ...
    yMeasures: ['winRate'],
    dimensions: [
      { key: 'cycleDays', label: 'Cycle Days', dataPath: 'cycleDays', type: 'number' },
    ],
    measures: [
      {
        key: 'winRate',
