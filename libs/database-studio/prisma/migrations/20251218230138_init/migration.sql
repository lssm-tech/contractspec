...
-- CreateIndex
CREATE INDEX "integration_connection_organizationId_integrationKey_integr_idx" ON "lssm_sigil"."integration_connection"("organizationId", "integrationKey", "integrationVersion");
...
-- AddForeignKey
ALTER TABLE "lssm_sigil"."integration_connection" ADD CONSTRAINT "integration_connection_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "lssm_sigil"."organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "lssm_learning"."learner" ADD CONSTRAINT "learner_userId_fkey" FOREIGN KEY ("userId") REFERENCES "lssm_sigil"."user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lssm_learning"."learner" ADD CONSTRAINT "learner_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "lssm_sigil"."organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lssm_learning"."onboarding_step" ADD CONSTRAINT "onboarding_step_trackId_fkey" FOREIGN KEY ("trackId") REFERENCES "lssm_learning"."onboarding_track"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lssm_learning"."onboarding_progress" ADD CONSTRAINT "onboarding_progress_learnerId_fkey" FOREIGN KEY ("learnerId") REFERENCES "lssm_learning"."learner"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lssm_learning"."onboarding_progress" ADD CONSTRAINT "onboarding_progress_trackId_fkey" FOREIGN KEY ("trackId") REFERENCES "lssm_learning"."onboarding_track"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lssm_learning"."onboarding_step_completion" ADD CONSTRAINT "onboarding_step_completion_progressId_fkey" FOREIGN KEY ("progressId") REFERENCES "lssm_learning"."onboarding_progress"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lssm_learning"."onboarding_step_completion" ADD CONSTRAINT "onboarding_step_completion_stepId_fkey" FOREIGN KEY ("stepId") REFERENCES "lssm_learning"."onboarding_step"("id") ON DELETE CASCADE ON UPDATE CASCADE;
